...
const PhotoListItem = forwardRef<HTMLImageElement, { src: string }>(
  (props, ref) => {
...
const PhotoList = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="list-none p0 m0 grid grid-cols-5 gap-4">
          {images.map((src, i) => (
            <PhotoView key={src + i} src={src}>
              <PhotoListItem src={src} />
